...
class SingleGoalGridState(AbstractState):
    ...
    def get_neighbors(self):
        ...
        for neighbor in neighboring_grid_locs:
            new_state = SingleGoalGridState(neighbor,self.goal,self.dist_from_start+1,self.use_heuristic,self.maze_neighbors)
